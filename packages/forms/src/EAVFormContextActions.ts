...
export type EAVCollectContext<TValues, TState extends EAVFormContextState<TValues>, TCollected> = [
  TCollected,
  EAVFormContextActions<TValues, TState>,
  string,
];

export type EAVFormCollectorRegistrationHandler<
  TValues,
  TState extends EAVFormContextState<TValues>,
> = <TCollected>(
