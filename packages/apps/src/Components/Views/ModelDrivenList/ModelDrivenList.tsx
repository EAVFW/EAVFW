...
export const ModelDrivenList: React.FC<ModelDrivenListProps> = ({ className, items, selectionMode, setKey, onItemInvoked, onRenderItemColumn, onRenderDetailsFooter }: ModelDrivenListProps) => {
