                ...
                onChange={(data) => {
                  onFormDataChange?.({
                    [activeViewRef!.entity.collectionSchemaName.toLowerCase()]: [
                      ...(formData[activeViewRef.entity.collectionSchemaName.toLowerCase()] ?? []),
                      data,
                    ],
                  } as any);
                }}
      ...
      for (const key in obj) {
        if (Object.prototype.hasOwnProperty.call(obj, key)) {
          ...
          if (Array.isArray(value)) {
            ...
            queue.push(
              expressionProvider(formValues, value).then((newvalue) => (clone[key] = newvalue)),
            );
          } else {
            clone[key] = value;
          }
...
export const JsonScheamSection: React.FC<
  JsonScheamSectionProps & Required<AutoFormJsonSchemaDefinition>
> = ({ schema, uiSchema, logicalName, sectionName }) => {
