...
export const WorkFlowDialog = ({
  ...
  useEffect(() => {
    if (rjsfProps && selection.count === 1) {
      ...
      setPayload(
        Object.fromEntries(
          Object.entries({ ...selection.getSelection()[0] }).filter(([p, v]) => p in props),
        ),
      );
    }
            ...
            {rjsfProps && (
              <Form
                ...
                templates={{
                  ...
                  FieldTemplate: React9FieldTemplate,
                }}
                {...rjsfProps}
              >
                <></>
              ...
              onClick={async () => {
                ...
                let { result, rsp } = await runWorkflow(
                  ...
                  'Manual',
                  {
                    ...
                    selection: selection
                      .getSelection()
                      .map((x) => ({ id: x.id, ['$type']: x.entityName })),
                  },
...
export const RegisterWorkflowRibbonButton = (
  ribbonkey: string,
  propsDefaults: Omit<WorkFlowDialogProps, 'ribbonkey'> = {},
) =>
